...
This file is the quick-reference operating contract for assert-cmd-kotlin. The longer
...
assert-cmd-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`assert_cmd`](https://crates.io/crates/assert_cmd). Upstream Rust is the behavioral oracle while the
